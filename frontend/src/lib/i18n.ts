...
const ru = {
  ...
  "dashboard.noIncomeThisMonth": "За этот месяц пока нет доходов. Добавьте первую транзакцию на вкладке «Транзакции».",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "dashboard.noIncomeThisMonth": "No income yet this month. Add your first transaction on the Transactions tab.",
