...
/** Donut + legend breakdown of a period's amounts by top-level category —
 * shared shape behind both the Dashboard's spending and income cards (see
 * services/dashboard_service.py's _category_breakdown, which produces the
 * same CategoryBreakdownItem list for either transaction type). */
export function CategoryDonutCard({ title, emptyMessage, items }: CategoryDonutCardProps) {
